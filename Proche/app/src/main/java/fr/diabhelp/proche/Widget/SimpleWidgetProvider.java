...
import fr.diabhelp.proche.Proche;
...
//        CharSequence widgetText = context.getString(R.string.appwidget_text);
        ...
        Intent firstDialogIntent = new Intent(context, Proche.class);
        ...
        views.setOnClickPendingIntent(R.id.actionimage, firstDialogPendingIntent);
