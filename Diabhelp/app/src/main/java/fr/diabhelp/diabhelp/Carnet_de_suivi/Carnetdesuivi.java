package fr.diabhelp.diabhelp.Carnet_de_suivi;
...
import fr.diabhelp.diabhelp.Carnet_de_suivi.API.Response.ResponseCDSGetAllEntries;
import fr.diabhelp.diabhelp.Carnet_de_suivi.API.Response.ResponseMail;
import fr.diabhelp.diabhelp.Carnet_de_suivi.API.Task.BddSyncrhroCDSGetAllEntriesApiCallTask;
import fr.diabhelp.diabhelp.Carnet_de_suivi.API.Task.ExportAPICallTask;
...
import fr.diabhelp.diabhelp.Carnet_de_suivi.Carnet.DayResultActivity;
import fr.diabhelp.diabhelp.Carnet_de_suivi.Carnet.EntryActivity;
import fr.diabhelp.diabhelp.Carnet_de_suivi.Carnet.ExpandableListAdapters;
import fr.diabhelp.diabhelp.Carnet_de_suivi.Carnet.Statistics.StatisticsActivity;
...
import fr.diabhelp.diabhelp.Carnet_de_suivi.Utils.MyToast;
import fr.diabhelp.diabhelp.Carnet_de_suivi.Utils.NetBroadcast.ConnectivityReceiver;
import fr.diabhelp.diabhelp.Carnet_de_suivi.Utils.SharedContext;
...
public class Carnetdesuivi extends AppCompatActivity implements IApiCallTask, ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    public void initActivity()
    {
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                final Activity dayresult = Carnetdesuivi.this;
    ...
    // Cette fonction à été créer a son appelant j'arrivais pas a call finish
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_main_cds, menu);
        return true;
    }
    ...
    private void fillAverageGly() {
        ...
        mAll = EntryOfCDSDAO.selectAllOneday(formattedDate, idUser, db); //sensé etre idUser au lieux de 0
        int size = 0;
        if (mAll.size() > 0) {
            while (idx < mAll.size()) {
    ...
    protected ArrayList<String> fillDate() {
        ...
        Log.i("fildate", "before while");
        while (idx < mall.size())
        {
            Log.i("filldate", "in while");
